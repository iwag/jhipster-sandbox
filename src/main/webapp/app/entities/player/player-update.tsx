...
export interface IPlayerUpdateProps extends StateProps, DispatchProps, RouteComponentProps<{ id: number }> {}
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="blogApp.player.home.createOrEditLabel">Create or edit a Player</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : playerEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="player-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="created_atLabel" for="created_at">
                    Created At
                  </Label>
                  <AvField id="player-created_at" type="date" className="form-control" name="created_at" />
                </AvGroup>
